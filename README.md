...
## Requirements
- python >=3.5 
- pytorch 0.3.0 (please refer to [the previous version](https://github.com/hitvoice/DrQA/tree/303bbfe43fe51d4e437aaeeecf734a8f9922d83e) if you use pytorch 0.2.0)
- numpy
- msgpack
- spacy 1.x
